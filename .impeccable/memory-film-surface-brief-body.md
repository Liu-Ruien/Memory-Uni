...
- Audience: 一起经历大学四年的十几位同学，桌面与手机浏览器均可完整观看。

## Job, action, proof and constraints

- 第一动作：确认真实照片已经就绪并按下“开始放映”；终点：看完一段由同一批照片持续重组的共同回忆，并可重播或返回相册。
...
| 退出、重播、返回 | 指针出现时随时可见；键盘焦点与触控面积完整 | Semantic buttons/anchors + functional glass |
